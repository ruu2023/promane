...
const initialProjects: Project[] = [
  {
    ...
    tasks: [
      ...
      { id: "t2", name: "Chapter 2: Particles", projectId: "1", dueDate: "2025-10-25", tags: ["grammar"] },
      {
        id: "t3",
      ...
      { id: "t4", name: "Practice Exercises Set A", projectId: "1", dueDate: "2025-11-01", tags: ["practice"] },
      { id: "t5", name: "Practice Exercises Set B", projectId: "1", dueDate: "2025-11-05", tags: ["practice"] },
      { id: "t6", name: "Review and Quiz", projectId: "1", dueDate: "2025-11-10", tags: ["review", "quiz"] },
    ],
  },
  {
    id: "2",
    ...
    tasks: [
      ...
      { id: "t8", name: "Render Props Pattern", projectId: "2", dueDate: "2025-10-20", tags: ["patterns"] },
      { id: "t9", name: "Higher Order Components", projectId: "2", dueDate: "2025-10-23", tags: ["patterns", "hoc"] },
      { id: "t10", name: "Custom Hooks Deep Dive", projectId: "2", dueDate: "2025-10-26", tags: ["hooks"] },
      {
        id: "t11",
  ...
  },
  {
    ...
    goalDate: "2025-11-30",
    tasks: [
      { id: "t12", name: "Linear Regression Theory", projectId: "3", dueDate: "2025-10-22", tags: ["theory", "ml"] },
      { id: "t13", name: "Gradient Descent Algorithm", projectId: "3", dueDate: "2025-10-28", tags: ["algorithms"] },
      { id: "t14", name: "Neural Networks Basics", projectId: "3", dueDate: "2025-11-05", tags: ["neural-networks"] },
      {
        id: "t15",
